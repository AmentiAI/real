...
import { MapPin, Phone, Users, TrendingUp, Star, CheckCircle, Award, Target, Globe, ArrowRight, Sparkles, Shield, Zap } from 'lucide-react'
import Link from 'next/link'
import { useBranding } from '@/components/BrandingProvider'

export default function CranstonContent() {
          ...
          <div className="text-center">
            ...
            <h1 className="text-5xl lg:text-6xl font-bold text-white mb-8 leading-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400">
                Dominates Cranston Search Results
              </span>
            </h1>

            {/* Subheadline */}
            <p className="text-xl lg:text-2xl text-blue-100 max-w-4xl mx-auto leading-relaxed mb-12">
              We help Cranston businesses achieve first-page Google rankings, increase organic traffic by 400%, 
              and generate over $2.3M in additional revenue using cutting-edge AI technology.
            </p>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
              <div className="group text-center p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 hover:bg-white/10 transition-all duration-300 hover:scale-105 transform">
                <div className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent mb-2 group-hover:scale-110 transition-transform duration-200">25+</div>
                <div className="text-blue-200 text-sm font-medium">Cranston Businesses</div>
              </div>
              <div className="group text-center p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 hover:bg-white/10 transition-all duration-300 hover:scale-105 transform">
                <div className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent mb-2 group-hover:scale-110 transition-transform duration-200">310%</div>
                <div className="text-blue-200 text-sm font-medium">Traffic Growth</div>
              </div>
              <div className="group text-center p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 hover:bg-white/10 transition-all duration-300 hover:scale-105 transform">
                <div className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent mb-2 group-hover:scale-110 transition-transform duration-200">97%</div>
                <div className="text-blue-200 text-sm font-medium">Client Satisfaction</div>
              </div>
              <div className="group text-center p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 hover:bg-white/10 transition-all duration-300 hover:scale-105 transform">
                <div className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-orange-400 to-red-400 bg-clip-text text-transparent mb-2 group-hover:scale-110 transition-transform duration-200">3+</div>
                <div className="text-blue-200 text-sm font-medium">Years Serving Cranston</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
          <div className="text-center mb-20">
            <div className="inline-flex items-center px-6 py-3 bg-white/80 backdrop-blur-sm border border-blue-200/50 rounded-full text-blue-700 text-sm font-medium mb-8 shadow-lg">
              ...
              Why Cranston Businesses Choose {branding.company_name}
            </div>
            ...
            <p className="text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
              We combine cutting-edge AI technology with deep local market knowledge to deliver 
              exceptional results for Cranston businesses.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group bg-white/80 backdrop-blur-sm rounded-3xl p-8 text-center shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 hover:scale-105 transform border border-white/50">
              ...
              <p className="text-slate-600 leading-relaxed group-hover:text-slate-700 transition-colors duration-300">
                Deep understanding of Cranston's business landscape and local search patterns for maximum impact.
              </p>
            </div>
            ...
            <div className="group bg-white/80 backdrop-blur-sm rounded-3xl p-8 text-center shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 hover:scale-105 transform border border-white/50">
              ...
              <p className="text-slate-600 leading-relaxed group-hover:text-slate-700 transition-colors duration-300">
                25+ successful Cranston businesses with 97% satisfaction rate and measurable growth.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
          <div className="text-center mb-16">
            <div className="inline-flex items-center px-6 py-3 bg-white/80 backdrop-blur-sm border border-green-200/50 rounded-full text-green-700 text-sm font-medium mb-8 shadow-lg">
              <Star className="w-5 h-5 mr-2" />
              Real Cranston Success Story
            </div>
            <h2 className="text-5xl lg:text-6xl font-bold bg-gradient-to-r from-slate-900 via-blue-900 to-indigo-900 bg-clip-text text-transparent mb-8">
              Cranston Medical Practice Transformation
            </h2>
            <p className="text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
              See how we helped a local medical practice achieve extraordinary growth with our AI-powered strategies.
            </p>
          </div>
              ...
              <div>
                <div className="mb-8">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-slate-900">Dr. Sarah Williams</h3>
                      <p className="text-blue-600 font-semibold">Cranston Family Practice</p>
                    </div>
                  </div>
                  <blockquote className="text-xl text-slate-600 leading-relaxed italic mb-8">
                    "{branding.company_name} completely transformed our practice. We went from struggling to attract new patients 
                    to having a waiting list. The AI-powered SEO strategy they implemented was unlike anything 
                    we'd seen before."
                  </blockquote>
                </div>
                ...
                <div className="grid grid-cols-3 gap-6">
                  ...
                  <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl border border-blue-200">
                    <div className="text-4xl font-bold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent mb-2">160%</div>
                    <p className="text-sm font-semibold text-blue-700">More Patients</p>
                  </div>
                  <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl border border-purple-200">
                    <div className="text-4xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent mb-2">140%</div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start group">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-sm">Ranked #1 for "family doctor Cranston" in 3 months</p>
                    </div>
                  </div>
                  <div className="flex items-start group">
                    <div className="w-8 h-8 bg-green-100 rounded-lg flex items-center justify-center mr-4 mt-1 group-hover:bg-green-200 transition-colors duration-300">
                    ...
                    <div>
                      <h4 className="font-bold text-slate-900 mb-1">Modern Website Design</h4>
                      <p className="text-slate-600 text-sm">Patient portal with online appointment booking</p>
                    </div>
                  </div>
                  <div className="flex items-start group">
                    <div className="w-8 h-8 bg-green-100 rounded-lg flex items-center justify-center mr-4 mt-1 group-hover:bg-green-200 transition-colors duration-300">
                  ...
                  <div className="flex items-start group">
                    ...
                    <div>
                      <h4 className="font-bold text-slate-900 mb-1">Content Marketing Strategy</h4>
                      <p className="text-slate-600 text-sm">Health-focused blog content that ranks and converts</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-24 bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center relative">
          <div className="inline-flex items-center px-6 py-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full text-white text-sm font-medium mb-8">
            ...
            Ready to Transform Your Cranston Business?
          </div>
          ...
          <p className="text-xl lg:text-2xl text-blue-100 mb-12 max-w-4xl mx-auto leading-relaxed">
            Get your free Cranston SEO audit and discover how our AI-powered strategies can help your business 
            dominate local search results and attract more customers.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              ...
              <div className="text-blue-200 text-sm font-medium">SEO Audit</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
