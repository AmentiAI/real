...
async function updateTables() {
  ...
  try {
    console.log('Updating content tables...')

    // Add missing columns to blog_posts
    await client.query(`
      ALTER TABLE blog_posts 
      ADD COLUMN IF NOT EXISTS author VARCHAR(100),
      ADD COLUMN IF NOT EXISTS read_time VARCHAR(20),
    ...
    console.log('Content tables updated successfully!')
  } catch (error) {
    console.error('Error updating content tables:', error)
    throw error
  } finally {
    client.release()
  }
